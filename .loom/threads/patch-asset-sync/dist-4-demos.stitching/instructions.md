...
- [x] If the PD demo needs `main.pd` edits to read `BOPOS_ASSETS`/
...
- [x] Update `friction-1-starter-kit` instructions: the starter kit *is* the
      demos now (its templates/ RESOLVED note is superseded — already
      flagged there 2026-07-13).
- [x] Verify: both demos pass `python/manifest.py` validation; demo-sc
