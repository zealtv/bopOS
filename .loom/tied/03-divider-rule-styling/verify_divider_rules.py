        ...
        try:
            ...
            with sync_playwright() as playwright:
                ...
                check("unnamed divider rule does not overlap the grab handle",
                      un and un["handle"] and un["ruleLeft"] is not None
                      and un["ruleLeft"] >= un["handle"]["right"],
                      f"ruleLeft={un and un['ruleLeft']} handleRight="
                      f"{un and un['handle'] and un['handle']['right']}")
                check("unnamed divider rule spans most of the row width",
                      un and un["ruleRight"] is not None
                      and (un["ruleRight"] - un["ruleLeft"]) > un["row"]["width"] * .8,
                      repr(un))
