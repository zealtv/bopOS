# Proposed next sweep after tabs-2

This ordering turns the independent review into small stitches. All remain
waiting for Bob's acceptance of the review; no implementation begins here.
...
4. `04-venue-point-persistence`: decide/land production point persistence in
   installation and venue state with migration/verification.
