...
Status: **awaiting Bob's ratification**. This proposal incorporates Bob's
...
- explicitly promoted framework commands such as restart engine, reboot and
  shutdown, with the existing confirmation/hold safeguards;
