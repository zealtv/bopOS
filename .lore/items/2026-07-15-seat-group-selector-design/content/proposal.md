...
The proposal recommends the following as one coherent decision:
...
Ratifying these points is enough to lock the cross-impact in the nested
parameter-address proposal. UI layout details can remain with the Seats and
Dashboard live-control stitches.
