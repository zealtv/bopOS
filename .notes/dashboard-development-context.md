# bopOS Web Dashboard — Development Context

This document is a self-contained reference for building the bopOS web
...
bopOS is a distributed sound installation framework. Multiple Raspberry Pis,
